const Experience: React.FC = () => {
  return (
    <section className="text-white">
      ...
      <div
        tabIndex={0}
        className="collapse collapse-open rounded-box w-5/6 md:w-3/4 lg:w-6/12 mx-auto"
      >
        <div className="collapse-title text-[4vw] md:text-[2.8vw] lg:text-[1.5vw] xl:text-[1.15vw] font-medium bg-[#00b200] flex flex-row content-center">
          <span>Frontend Engineer Intern @</span>
          <a
            aria-label="Bosta Link"
            href="https://bosta.co/"
            target="_blank"
          ...
          >
            <svg
              ...
              aria-hidden="true"
              focusable="false"
              className="h-8 w-20 md:w-32 ml-3"
            >
              <path
        ...
        <div className="collapse-content rounded-box bg-gradient-to-r from-[#16222e] to-[#131b26] font-['cursive'] tracking-widest">
          ...
          <p className="mt-5">July 2019 - October 2019</p>
          <p className="mt-5">
            Under supervision of senior software engineers, built a website
            using React, Redux and React Bootstrap about stations, clerks and
            companies connecting with each other.
          </p>
