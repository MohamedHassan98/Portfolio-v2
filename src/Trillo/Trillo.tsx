...
const Trillo: React.FC = () => {
  return (
    ...
    >
      <img
        src={TrilloLogo}
        className="absolute top-[10%] sm:top-[20%] lg:top-[40%] left-[35%] lg:left-[45%] opacity-10 pointer-events-none scale-150"
      />
      ...
      <div className="grid md:grid-cols-2 font-['cursive'] tracking-widest gap-14 text-[4vw] md:text-[2vw] lg:text-[1.25vw] xl:text-[1vw] mb-10 lg:mb-36">
        <AnimateDiv type="left">
          <p>
            ...
            built using only HTML and CSS. The application is a one page
      ...
      <AnimateDiv type="up">
        <div className="flex flex-col gap-y-10 items-center mb-8">
          <img src={TrilloImage} alt="Project Image" />
          <img src={TrilloImageMobile} alt="Project Image" />
        </div>
      </AnimateDiv>
    </div>
  );
